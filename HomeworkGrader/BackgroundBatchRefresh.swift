...
enum AppBatchRefreshCoordinator {
    ...
    private static func recordBatchOutputDebug(
        _ submission: StudentSubmission,
        requestID: String,
        rawLineJSON: String?
    ) {
    ...
    private static func recordBatchErrorDebug(
        _ submission: StudentSubmission,
        requestID: String,
        rawLineJSON: String?,
        message: String
    ...
    private static func recordLookupDebug(
        _ submission: StudentSubmission,
        requestID: String,
        summary: String
    ) {
    ...
    private static func debugPhaseTitle(for submission: StudentSubmission) -> String {
        switch submission.batchStage {
        case .queued:
            return "Queued"
        case .grading:
